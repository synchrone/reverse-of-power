...
class DebugLauncherFragment : Fragment() {
    ...
    private val powerTypeOptions = listOf(
        ...
        PowerType.BOMBLES to "Bombs",
        PowerType.NIBBLERS to "Munchers",
        PowerType.GLOOP to "Gloop",
        PowerType.DOUBLE_TROUBLE_FREEZE_GLOOP to "DT: Freeze+Gloop",
        PowerType.DOUBLE_TROUBLE_FREEZE_BOMBLES to "DT: Freeze+Bombs",
        PowerType.DOUBLE_TROUBLE_NIBBLERS_GLOOP to "DT: Munchers+Gloop",
